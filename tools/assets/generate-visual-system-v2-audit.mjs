...
const audit={
  ...
  fontFamilies:grouped(fontMap),paletteColors:colors,crimsonRedValues,strokeWidths:grouped(strokeMap),radiusValues:grouped(radiusMap),
  graphGeometrySignatures:grouped(geometryMap),duplicateCandidates:{exact:exactDuplicates,structural:structuralDuplicates},
