...
| Delivery files indexed in showcase | **1,544 / 1,544** |
| Showcase coverage | **100%** |
| Canonical MoonWitness SVG sources | **650** |
| PNG / APNG delivery files | **841** |
...
7. **1,544 / 1,544 delivery files remain reachable from the showcase registry**;
